...
export const metadata: Metadata = {
  ...
  description:
    'Единственный физико-технический факультет в Беларуси. Программирование, кибербезопасность, ИИ, радиофизика, аэрокосмические технологии.',
}
  ...
  return (
    <div data-pagefind-body>
      ...
      <AboutTeaser
        ...
        headline="Единственный физико-технический факультет в Беларуси"
        body="Готовим специалистов мирового уровня. Уникальное сочетание: информатика, программирование, радиофизика, электроника. С нами работали над проектами Марс, Венера, Буран-Энергия и первым белорусским наноспутником БГУСат-1."
        achievements={[
