...
export const metadata: Metadata = {
  title: 'Физика полупроводников и материаловедение — ФРКТ БГУ',
  description: 'Научная школа в области физики полупроводников и материаловедения факультета радиофизики и компьютерных технологий БГУ.',
}

export default function SchoolSemiconductorPage() {
  const mdxPath = path.join(process.cwd(), 'src', 'content', 'science', 'school-semiconductor.mdx')
  ...
  return (
    <div className="min-h-screen bg-bg-primary" data-pagefind-body>
      <PageHero
        ...
        subtitle="Ведущая научная школа факультета в области физики твёрдого тела и полупроводниковых материалов."
        coverImage={{
          src: '/images/specialty_digital_tech.jpg',
          alt: 'Научная школа физики полупроводников',
          priority: true,
        }}
      />
