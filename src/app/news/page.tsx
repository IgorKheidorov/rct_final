  ...
  return (
    <div className="min-h-screen bg-bg-primary" data-pagefind-body>
      ...
      <section className="bg-bg-section border-b border-border-col py-16 px-6 md:px-20">
        <SectionLabel>// НОВОСТИ И СОБЫТИЯ</SectionLabel>
        <h1 className="font-display text-4xl md:text-5xl text-text-primary mt-4">
          Новости ФРКТ
        </h1>
        <p className="text-text-secondary mt-3 max-w-xl">
          Последние события, достижения студентов и научные новости факультета.
        </p>
      </section>

      {/* Tag filters */}
      <section className="border-b border-border-col px-6 md:px-20 py-4">
