...
const KEY_POINTS = [
  ...
  'Подготовка в сфере кибербезопасности, ИИ, квантовых вычислений, IoT и аэрокосмических технологий',
  'Уникальный сплав знаний: информатика, программирование, радиофизика и электроника',
  'Выпускники востребованы в ИТ-компаниях, центрах кибербезопасности и ведущих научных центрах страны',
]
  ...
  return (
    <div data-pagefind-body>
      <PageHero
        ...
        title="О факультете"
        subtitle="Единственный в Республике Беларусь факультет физико-технического профиля: кибербезопасность, искусственный интеллект, квантовые вычисления и аэрокосмические технологии."
        coverImage={{
          src: '/images/faculty_building.jpg',
          alt: 'Корпус факультета радиофизики и компьютерных технологий БГУ, ул. Академика Курчатова, 5',
          priority: true,
        }}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
          <div>
            ...
            <p className="font-body text-base text-text-secondary leading-[1.75] mb-6">
              ФРКТ — единственный в Республике Беларусь факультет физико-технического профиля,
              готовящий специалистов в сфере программирования и кибербезопасности, искусственного
              интеллекта и квантовых вычислений, интернета вещей и аэрокосмических технологий.
            </p>
            <p className="font-body text-base text-text-secondary leading-[1.75]">
              Только здесь вы получите уникальный сплав знаний по информатике, программированию,
              радиофизике и электронике — востребованный современной наукой и индустрией.
              Наши выпускники работают на государственных и частных наукоёмких предприятиях,
              в центрах кибербезопасности, ИТ-компаниях и ведущих научных центрах страны.
            </p>
          </div>
